...
export default function BlogPage() {
  ...
  return (
    <div className={`min-h-screen transition-all duration-300 ${
      ...
      {/* サイドバー */}
      <aside className={`fixed left-0 top-0 h-full w-64 z-30 transition-all duration-300 ${
        theme === 'dark'
          ? 'bg-gray-900/80 backdrop-blur-xl border-r border-gray-700/50'
        ...
        <div className="p-6 h-full flex flex-col">
          ...
          {isLoggedIn && (
            <button
              ...
              className="w-full px-4 py-3 rounded-xl bg-gradient-to-r from-red-500 to-pink-500 text-white font-medium hover:from-red-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              {dict.logout}
            </button>
          )}
        ...
        <main className="px-8 pb-8">
          ...
          <div className="mb-8 text-center">
            <button
              ...
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-2xl hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-xl hover:shadow-2xl"
            >
          ...
          <div className={`mb-8 p-6 rounded-2xl ${
            ...
            <div className="flex flex-wrap gap-4 items-center justify-center mb-4">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-xl hover:from-blue-600 hover:to-blue-700 transform hover:scale-105 transition-all duration-200 shadow-lg"
              >
                {dict.search}
              </button>
            </div>
          ...
          <div className="grid gap-6">
            {posts.length === 0 ? (
              <div className={`text-center py-12 ${
                ...
                <p className="text-lg font-medium mb-2">{dict.noPosts}</p>
                <p className="text-sm opacity-75">{dict.createFirst}</p>
              </div>
            ) : (
              posts.map((post) => (
                <article
                  key={post.id}
                  className={`group relative overflow-hidden rounded-2xl transition-all duration-300 hover:transform hover:scale-[1.02] ${
                    theme === 'dark'
